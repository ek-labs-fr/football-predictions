...
questions like "did this retrain produce better predictions?" or, after a
future decision-rule change, "did the new rule outperform argmax_v0?"

Predictions written before lineage stamping land in an ``unstamped`` /
``unknown`` bucket so historical data is still accounted for.
